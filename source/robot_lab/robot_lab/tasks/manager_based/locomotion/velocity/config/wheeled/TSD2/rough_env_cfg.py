...
# Pre-defined configs
##
from robot_lab.assets.TSD import TSD2_CFG  # isort: skip


@configclass
class TSD2ActionsCfg(ActionsCfg):
...
@configclass
class TSD2RewardsCfg(RewardsCfg):
...
@configclass
class TSD2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    actions: TSD2ActionsCfg = TSD2ActionsCfg()
    rewards: TSD2RewardsCfg = TSD2RewardsCfg()
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = TSD2_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "TSD2RoughEnvCfg":
